<template>
    <section class="relative w-full h-screen flex flex-col items-center justify-evenly bg-cover bg-center overflow-hidden">
        <div class="font-serif bg-my_gray_op w-full h-1/4 flex px-48 items-center justify-evenly text-3xl select-none">
            <p><a class="p-2 border-b-2 border-b-my_pink" href="" @click.prevent="setCategory('architecture')">Архитектура</a></p>
            <p><a class="hover:border-b-2 hover:border-b-my_pink_op" href="" @click.prevent="setCategory('engineering')">Инженеринг</a></p>
            <p><a class="hover:border-b-2 hover:border-b-my_pink_op" href="" @click.prevent="setCategory('design')">Дизайн</a></p>
        </div>
        <!-- карусель -->
...
// Глобальная регистрация модулей
