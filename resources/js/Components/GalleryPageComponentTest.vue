        ...
        const components = reactive([
            {
                ...
                props: {
                    ...
                    allitems: fetchData('architecture')
                }
            },
            {
                name: markRaw(GalleryComponent),
                props: {
                    title: 'Инжиниринг',
                    description: 'Детали инженерных решений',
                    allitems: fetchData('engineering')
                }
            },
            {
                name: markRaw(GalleryComponent),
                props: {
                    title: 'Дизайн',
                    description: 'Детали дизайн-проектов',
                    allitems: fetchData('design')
                }
            }
        ]);
